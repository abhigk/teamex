...
export default class TxContactUsMain extends React.Component {
    constructor(props) {
        super(props)
                    ...
                    <Row>
                        <Col md="6" style={formBlock}>
                            <div style={{ alignSelf: 'center' }}>
                                ...
                                <Row>
                                    <Col>
                                        <div style={{ width: '20em', paddingBottom: '2em' }}>For any general inquiries, please fill in the following contact form:</div>
                                    </Col>
                                </Row>
                                <Row style={{ paddingBottom: '5em' }}>
                                    <Form style={{ paddingLeft: '1em' }} >
                                        ...
                                        <Button style={contactBtn} onClick={() => this.contactQuery()}>Submit</Button>
                                    </Form>
                                </Row>
                            </div>
                        </Col>
